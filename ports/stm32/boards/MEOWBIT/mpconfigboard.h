...
#define MICROPY_HW_HAS_ST7735       (1)
// #define MICROPY_HW_ENABLE_RTC       (1)
#define MICROPY_HW_ENABLE_USB       (1)
#define MICROPY_HW_ENABLE_STORAGE   (1)
#define MICROPY_HW_ENABLE_SDCARD    (1)

#define MICROPY_HW_ENABLE_IMAGE     (1)
#define MICROPY_HW_IMAGE_BMP
#define MICROPY_HW_IMAGE_GIF
#define MICROPY_HW_IMAGE_JPEG
#define MICROPY_HW_IMAGE_P16
#define MICROPY_HW_IMAGE_P256
